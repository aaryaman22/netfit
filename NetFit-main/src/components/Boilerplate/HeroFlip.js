        ...
        <div class="md:flex"> 
            ...
            <div class="flex items-center justify-center w-full px-10 py-8 md:h-128 md:w-1/2">
                <div class="max-w-xl">
                    ...
                    <div class="flex mt-6">
                        <a href="/diet" class="block px-4 py-3 text-md font-semibold text-white transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700">Read now</a>
